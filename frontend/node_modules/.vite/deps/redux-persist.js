import { i as combineReducers, o as createStore } from "./redux-DYEJS5Ug.js";
//#region node_modules/.pnpm/redux-persist@6.0.0_react@18.3.1_redux@5.0.1/node_modules/redux-persist/es/constants.js
...
//#endregion
//#region node_modules/.pnpm/redux-persist@6.0.0_react@18.3.1_redux@5.0.1/node_modules/redux-persist/es/stateReconciler/autoMergeLevel1.js
...
function _objectSpread$3(target) {
	for (var i = 1; i < arguments.length; i++) {
		...
		if (i % 2) ownKeys$3(source, true).forEach(function(key) {
			_defineProperty$3(target, key, source[key]);
		});
		else if (Object.getOwnPropertyDescriptors) Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));
		else ownKeys$3(source).forEach(function(key) {
...
//#endregion
//#region node_modules/.pnpm/redux-persist@6.0.0_react@18.3.1_redux@5.0.1/node_modules/redux-persist/es/createPersistoid.js
...
//#endregion
//#region node_modules/.pnpm/redux-persist@6.0.0_react@18.3.1_redux@5.0.1/node_modules/redux-persist/es/getStoredState.js
...
//#endregion
//#region node_modules/.pnpm/redux-persist@6.0.0_react@18.3.1_redux@5.0.1/node_modules/redux-persist/es/purgeStoredState.js
...
//#endregion
//#region node_modules/.pnpm/redux-persist@6.0.0_react@18.3.1_redux@5.0.1/node_modules/redux-persist/es/persistReducer.js
...
function persistReducer(config, baseReducer) {
	...
	return function(state, action) {
		...
		if (action.type === "persist/PERSIST") {
			...
			if (_persist) return _objectSpread$2({}, baseReducer(restState, action), { _persist });
			...
			return _objectSpread$2({}, baseReducer(restState, action), { _persist: {
				version,
				rehydrated: false
			} });
			...
			if (_purge) return _objectSpread$2({}, restState, { _persist: _objectSpread$2({}, _persist, { rehydrated: true }) });
			if (action.key === config.key) {
				var reducedState = baseReducer(restState, action);
				var inboundState = action.payload;
				return conditionalUpdate(_objectSpread$2({}, stateReconciler !== false && inboundState !== void 0 ? stateReconciler(inboundState, state, reducedState, config) : reducedState, { _persist: _objectSpread$2({}, _persist, { rehydrated: true }) }));
			}
		}
		if (!_persist) return baseReducer(state, action);
		var newState = baseReducer(restState, action);
		if (newState === restState) return state;
		return conditionalUpdate(_objectSpread$2({}, newState, { _persist }));
	};
}
//#endregion
//#region node_modules/.pnpm/redux-persist@6.0.0_react@18.3.1_redux@5.0.1/node_modules/redux-persist/es/stateReconciler/autoMergeLevel2.js
...
//#endregion
//#region node_modules/.pnpm/redux-persist@6.0.0_react@18.3.1_redux@5.0.1/node_modules/redux-persist/es/persistCombineReducers.js
function persistCombineReducers(config, reducers) {
	config.stateReconciler = config.stateReconciler === void 0 ? autoMergeLevel2 : config.stateReconciler;
	return persistReducer(config, combineReducers(reducers));
}
//#endregion
//#region node_modules/.pnpm/redux-persist@6.0.0_react@18.3.1_redux@5.0.1/node_modules/redux-persist/es/persistStore.js
...
//#endregion
//#region node_modules/.pnpm/redux-persist@6.0.0_react@18.3.1_redux@5.0.1/node_modules/redux-persist/es/createMigrate.js
...
//#endregion
//#region node_modules/.pnpm/redux-persist@6.0.0_react@18.3.1_redux@5.0.1/node_modules/redux-persist/es/createTransform.js
