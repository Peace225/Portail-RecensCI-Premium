import { A as deepEqual, B as isIE, C as Logger, D as base64Decode, E as FirebaseError, F as getModularInstance, G as querystring, H as isMobileCordova, I as getUA, K as querystringDecode, L as isBrowserExtension, M as getDefaultEmulatorHost, P as getExperimentalSetting, R as isCloudflareWorker, S as LogLevel, T as ErrorFactory, U as isReactNative, b as registerVersion, c as _getProvider, d as _registerComponent, h as getApp, j as extractQuerystring, k as createSubscribe, n as SDK_VERSION, u as _isFirebaseServerApp, w as Component, z as isEmpty } from "./index.esm2017-BE8TtOMB.js";
...
//#endregion
//#region node_modules/.pnpm/@firebase+auth@1.7.9_@firebase+app@0.10.13/node_modules/@firebase/auth/dist/esm2017/index-68602d24.js
/**
* @license
...
async function handleRecaptchaFlow(authInstance, request, actionName, actionMethod) {
	var _a;
	if ((_a = authInstance._getRecaptchaConfig()) === null || _a === void 0 ? void 0 : _a.isProviderEnabled("EMAIL_PASSWORD_PROVIDER")) return actionMethod(authInstance, await injectRecaptchaFields(authInstance, request, actionName, actionName === "getOobCode"));
...
async function _initializeRecaptchaConfig(auth) {
	...
	if (config.isProviderEnabled("EMAIL_PASSWORD_PROVIDER")) new RecaptchaEnterpriseVerifier(authInternal).verify();
}
/**
* @license
* Copyright 2020 Google LLC
